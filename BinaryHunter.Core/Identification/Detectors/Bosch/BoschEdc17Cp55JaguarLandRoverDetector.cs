...
// Jaguar/Land Rover Bosch EDC17CP55 full reads contain two independent Bosch
// runtime descriptors, a fixed-position JLR hardware record and a stable OEM
// software copy. The combined structure separates CP55 from shared Ford-style
// component numbers and from incidental EDC17C08 library strings.
internal sealed class BoschEdc17Cp55JaguarLandRoverDetector : IEcuDetectionModule
{
    ...
    private static readonly Regex PlatformPattern = new(
        @"\d{2,3}/1/(?<type>EDC17CP55)/190/(?<platform>P[A-Z0-9]+)//(?<calibration>P[A-Z0-9_]+)///",
    ...
    public string Name => "Bosch EDC17CP55 Jaguar/Land Rover";
    ...
    public IEnumerable<IdentifierMatch> Detect(EcuBinaryImage image)
    {
        ...
        [
            ...
            new() { Type = "ECU family", Value = "Bosch EDC17CP55", Offset = platform.Index },
            new() { Type = "ECU type", Value = "EDC17CP55", Offset = platform.Index },
            new() { Type = "Processor", Value = "Infineon TC1791/TC1793 (EDC17CP55 platform inference)", Offset = platform.Index },
